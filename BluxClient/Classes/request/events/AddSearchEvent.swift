...
public class AddSearchEvent: EventRequest {
    private static let DEFAULT_EVENT_TYPE: String = "search"
    ...
    public class Builder {
        ...
        var eventType: String = AddSearchEvent.DEFAULT_EVENT_TYPE
        ...
        public func build() throws -> AddSearchEvent {
            return try AddSearchEvent(builder: self)
        }
    }
}
